...
static void key_pressed_worker_func(async_context_t *context, async_when_pending_worker_t *worker) {
    (void) context;
...
void picow_access_point_task(void *param) {
    ...
    const char *ap_name = "liniowir";
    const char *password = "panzervor";
